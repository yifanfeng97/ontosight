...
hyperedges = [
    EdgeSchema(
        nodes=["author1", "author2", "paper1"], label="Co-authored: Paper 1", type="collaboration"
    ),
    EdgeSchema(
        nodes=["author2", "author3", "paper2"], label="Co-authored: Paper 2", type="collaboration"
    ),
    EdgeSchema(nodes=["paper1", "conf1"], label="Published at", type="publication"),
    EdgeSchema(nodes=["paper2", "conf2"], label="Published at", type="publication"),
]
if __name__ == "__main__":
    ...
    view_hypergraph(
        ...
        node_name_extractor=lambda node: node.id,
